...
% Users location
r(1) = 200;                         % 1st User's location
r(2) = 300;                         % 2nd User's location
r(3) = 250;                         % 3rd User's location
theta(1) = 0;                       % 1st User's location
theta(2) = 0;                       % 2nd User's location
theta(3) = deg2rad(45);             % 3rd User's location

K = length(r);                              % K denote the number of single-antenna users
